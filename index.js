...
function winCheck() {
  ...
  let winMessageComp = "Computer wins!!!";
  ...
  if (
    ...
    //- checking for tie
    alert(winBanner.innerText = tieMessage);
  }
  if (gameState.currentPlayer === "X") {
    if (array[0] === "X" && array[1] === "X" && array[2] === "X") {
      //----------------------------------------------------------- checking for win of X
    ...
    //--------------------------------------------------------------------- checking for win of computer
    if (
      array[0] === "computer" &&
      array[1] === "computer" &&
      array[2] === "computer"
    ) {
      alert((winBanner.innerText = winMessageComp));
    } else if (
      array[3] === "computer" &&
      array[4] === "computer" &&
      array[5] === "computer"
...
// New game -- reset the board --- listener
